...
- (void)updateUI {
    ...
    if (appDelegate.isRTL) {
        ...
        self.imgHeaderAppName.frame = CGRectMake(SCREEN_SIZE.width - 16 - self.imgHeaderAppName.frame.size.width, self.imgHeaderAppName.frame.origin.y, self.imgHeaderAppName.frame.size.width, self.imgHeaderAppName.frame.size.height);
    } else {
        ...
        self.imgHeaderAppName.frame = CGRectMake(16, self.imgHeaderAppName.frame.origin.y, self.imgHeaderAppName.frame.size.width, self.imgHeaderAppName.frame.size.height);
    }
}
